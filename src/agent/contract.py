...
class SnippetEffect(BaseModel):
    ...
    code: str = Field(
        description=(
            ...
            "'card_id', 'amount', 'target_player_ids'; ON_SCORE_CHANGE fires carry the "
            "score change in 'amount' (None when players moved by different amounts) and "
            "per-player changes in 'deltas' {player_id: change}; ON_VALIDATE_PLAY fires "
            "additionally carry 'card_title' "
