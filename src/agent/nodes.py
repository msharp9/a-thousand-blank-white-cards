"""agent.nodes — LangGraph interpretation nodes.
...
from agent.llm import get_chat_model, with_structured_output
...
def _get_retriever(mode: str):
    ...
    callers) can patch ``agent.nodes._retriever`` and have it take effect at
