...
class Room:
    ...
    async def _handle_create_card(self, player_id: str, msg) -> None:
        ...
        ``setup_progress`` and the start gate) and broadcast. Once this card
        completes the LAST player's authoring quota, the game AUTO-STARTS
        (setup→playing) — no manual "start" is required.
        """
