"""engine.events — canonical event names, HookContext, and the EventBus.
...
engine.hooks (late-imported to avoid a circular dependency).
"""
...
class EventBus:
    ...
    ``fire_hooks`` from engine.hooks. The import cycle is avoided via a
