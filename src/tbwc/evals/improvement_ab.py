...
Usage:
    OPENAI_API_KEY=... uv run python -m tbwc.evals.improvement_ab [--data PATH] [--limit N] [--retriever-mode dense]
...
from tbwc.evals.eval_core import EvalRunReport, compare_eval_reports, run_eval
from tbwc.evals.harness import DEFAULT_DATA, _normalise_graph_output, load_eval_items
