"""tbwc.rooms.store — pluggable storage backend for active game rooms.
...
WITHOUT touching :class:`tbwc.rooms.manager.RoomManager` — see the multi-worker
note there.
...
class RoomStore(Protocol):
    """Storage backend for active :class:`~tbwc.rooms.room.Room` instances.
...
class InMemoryRoomStore:
    ...
    :class:`tbwc.rooms.manager.RoomManager` for the multi-worker hazard this
